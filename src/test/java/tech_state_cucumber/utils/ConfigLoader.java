...
import static tech_state_cucumber.constants.FrameworkConstants.DIRECTORY_ENV_CONFIG;
import static tech_state_cucumber.constants.FrameworkConstants.ENV_CONFIG_INT;
import static tech_state_cucumber.constants.FrameworkConstants.ENV_CONFIG_PROD;
import static tech_state_cucumber.constants.FrameworkConstants.ENV_CONFIG_QA;
import static tech_state_cucumber.constants.FrameworkConstants.ENV_CONFIG_STG;
import static tech_state_cucumber.constants.FrameworkConstants.PARAMETER_ENV;

import java.util.Properties;

import tech_state_cucumber.enums.EnvType;
